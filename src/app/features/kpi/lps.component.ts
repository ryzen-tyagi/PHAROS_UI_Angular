...
/** Port of KPIs/LPS.jsx (LivePHAROSSystem). */
@Component({
  selector: 'app-lps',
  standalone: true,
  template: `
    <div
      style="width:100%;height:100vh;background:#000;display:flex;align-items:center;justify-content:center"
    >
      <svg #svg style="max-width:1200px;height:100%"></svg>
    </div>
  `,
})
export class LpsComponent implements AfterViewInit, OnDestroy {
  ...
  private render(): void {
    ...
    const layout = {
      dcHeat: { x: 140, y: 255, width: 150, height: 80 },
      orcGen: { x: 970, y: 255, width: 150, height: 80 },
